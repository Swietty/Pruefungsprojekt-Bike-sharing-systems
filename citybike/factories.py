"""
Factories module for Bike Sharing System.
Provides factory classes for creating Bikes and Users from dictionary data.
"""
...
class BikeFactory:
    ...
    def create_from_dict(data: Dict[str, Any]) -> Bike:
        ...
        if bike_type_enum == BikeType.CLASSIC:
            ...
            return ElectricBike(bike_id=bike_id, status=status,
...
class UserFactory:
    ...
    def create_from_dict(data: Dict[str, Any]) -> User:
        ...
        if user_type_enum == UserType.CASUAL:
            ...
            return MemberUser(user_id=user_id, name=name, email=email,
